...
label chapter2:
    ...
    "The calendar is fairly empty, you have a brunch with friends later today, and are hosting a dinner 
     party tomorrow."
...
label brunchchoice:
    ...
    "Shit!  They'll be expecting you. You and [spouse_name]. What do you do?"
    menu:
        "Go to brunch":
            jump brunch
        "Skip it":
...
label skipbrunch:
    ...
    "*phone rings*"
    sam "Hello?"
    "'*violently coughing* Ugh, sorry. Hey, this is [player_name]. I'm just calling to let you know that we 
...
label brunch:
    ...
    show patricia at right with easeinleft
    show sam at left with easeinright
    s "Hey, [player_name], how are you?"
    pa "Say, where's [spouse_name]?"
    "It's the question you've been dreading. How do you explain away your spouse's absence?"
    menu:
        "[spouse_name] is on a business trip.":
            pa "I thought [heshe] didn't work?"
            "She immediately looks embarrassed at what she has said."
            pa "I mean, not that there's anything wrong with that, of course. I just thought..."
            "Sam shushes her."
            sam "Don't be rude, Patricia. Maybe [heshe] got a new job."
            "He turns to you. "
            s "“I, for one, am glad to hear about this development in their career. You must be very proud. 
        ...
        "[spouse_name] is home sick.":
            ...
            menu:
                ...
                "'You know, I'm really not sure...'":
                    show sam at Move((0.15, 0.5), (0.1, 0.5), 1.0,
                                        xanchor="left", yanchor="center")
                    show patricia at Move((0.85, 0.5), (0.9, 0.5), 1.0,
                                        xanchor="right", yanchor="center")
                    "Patricia and Sam surreptitiously lean away from you."
                    s "Well, maybe it's better if you stay home, too. Wouldn't want to risk it, you know."
...
label lake:
    ...
    play sound ["Assets/Music/splashCut.mp3"]
