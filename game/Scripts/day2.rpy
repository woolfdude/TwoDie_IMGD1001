...
label day2lake:
    play sound ["Music/doorbell.mp3"]
    "You wake up to the sound of your doorbell. You peer out the peephole. The police!"
    scene bg garden real at truecenter with fade
    with Pause(1)
    scene bg garden at truecenter with dissolve
    show o1 at left with easeinleft
    show o2 at right with easeinright
    "'Excuse me, how can I help you today, officers?'"
    officer1 "We just have some questions we'd like to ask you, if you wouldn't mind coming down to the station 
        with us."
    ...
    show o2 at left with easeinleft
    officer2 "Do you know why you're here?" 
    menu:
        "Yes.":
            officer2 "Are you ready to confess, then?"
            menu:
                "Confess.":
                    jump confess
                "Don't confess.":
                    officer2 "You know why you're here, but you won't confess?" 
                    "The officer looks at you skeptically before sighing in frustration."
                    officer2 "Why can't you make this easier on all of us and just sign the damn confession?"
                    menu:
                        "Confess.":
                            jump confess
                        "Don't confess.":
                            "The officer growls at you. He leans across the table towards you and lowers his voice." 
                            officer2 "That was your last chance, and you've just made the second biggest mistake 
                            of your life after what you did. You're going away for a long, long time." 
                            "He storms out of the room."
                            hide o2 with dissolve
        ...
        "No.":
            "The officer growls at you. He leans across the table towards you and lowers his voice."
            officer2 "Don't play stupid with me. You know exactly why you're here, and you've just made 
